function ingles() {
    ...
    const desc3 = document.getElementById('desc3')    // NÃO MEXER

    const desc4 = document.getElementById('desc4')    // NÃO MEXER
    const desc5 = document.getElementById('desc5')    // NÃO MEXER
    const desc6 = document.getElementById('desc6')    // NÃO MEXER

    const desc7 = document.getElementById('desc7')    // NÃO MEXER
    const desc8 = document.getElementById('desc8')    // NÃO MEXER
    const desc9 = document.getElementById('desc9')    // NÃO MEXER

    const desc10 = document.getElementById('desc10')    // NÃO MEXER
    const desc11 = document.getElementById('desc11')    // NÃO MEXER
    const desc12 = document.getElementById('desc12')    // NÃO MEXER
